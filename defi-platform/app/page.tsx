...
const ParallaxText = ({ children, baseVelocity = 100 }) => {
  ...
  useEffect(() => {
    ...
    const tick = (t) => {
      if (prevT) {
        ...
        baseX.set(baseX.get() + delta * velocity.get())
      }
      prevT = t
  ...
  return (
    <div className="flex overflow-hidden whitespace-nowrap">
      <motion.div className="flex whitespace-nowrap" style={{ x: baseX }}>
        <span className="block mr-12">{children}</span>
        <span className="block mr-12">{children}</span>
        <span className="block mr-12">{children}</span>
        <span className="block mr-12">{children}</span>
...
// Partner logo component for the Cooperation section
const PartnerLogo = ({ name, logo, url }) => {
  const { isLowPerfDevice } = useReducedMotion()
  ...
  return (
    <motion.a
      ...
      className="flex flex-col items-center justify-center p-4 bg-card/80 backdrop-blur-sm rounded-xl border border-border/50 transition-all duration-300 hover:border-primary/30 hover:shadow-lg"
      whileHover={isLowPerfDevice ? {} : { y: -5, scale: 1.02 }}
      initial={{ opacity: 0, y: 20 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
...
export default function Home() {
  ...
  // Memoize partner data for the Cooperation section
  const partners = useMemo(
    () => [
      {
        name: "Ethereum Foundation",
        logo: "/ethereum-foundation-abstract.png",
        url: "https://ethereum.org",
      },
      {
        name: "Polygon Labs",
        logo: "/polygon-abstract-network.png",
        url: "https://polygon.technology",
      },
      {
        name: "Avalanche",
        logo: "/avalanche-abstract.png",
        url: "https://avax.network",
      },
      {
        name: "Solana Foundation",
        logo: "/stylized-solana-logo.png",
        url: "https://solana.com",
      },
      {
        name: "Chainlink",
        logo: "/stylized-chainlink-oracle.png",
        url: "https://chain.link",
      },
      {
        name: "Aave",
        logo: "/abstract-defi-aave.png",
        url: "https://aave.com",
      },
      {
        name: "Uniswap",
        logo: "/abstract-defi-flow.png",
        url: "https://uniswap.org",
      },
      {
        name: "Compound",
        logo: "/abstract-defi-network.png",
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <motion.section
        className="py-8 bg-muted/50 overflow-hidden"
        initial={{ opacity: 0 }}
      ...
      {/* Cooperation Section - Replacing Supported Assets & Chains */}
      <section className="py-20 bg-muted relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <FloatingElement xOffset={100} yOffset={-50} duration={7}>
            <div className="w-[500px] h-[500px] rounded-full bg-accent/5 blur-3xl absolute right-0 top-0" />
          </FloatingElement>
          <FloatingElement xOffset={-80} yOffset={150} duration={9}>
            <div className="w-[400px] h-[400px] rounded-full bg-primary/5 blur-3xl absolute left-0 bottom-0" />
          </FloatingElement>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl font-bold mb-4">Cooperation</h2>
            <p className="text-text/70">
              Peridot collaborates with leading blockchain protocols and DeFi platforms to create a seamless cross-chain
              experience.
            </p>
          </motion.div>
          ...
          >
            {partners.map((partner, index) => (
              <PartnerLogo key={partner.name} name={partner.name} logo={partner.logo} url={partner.url} />
            ))}
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.4 }}
          >
            <h3 className="text-xl font-bold mb-6">Become a Partner</h3>
            <p className="text-text/70 max-w-2xl mx-auto mb-8">
              Join our growing ecosystem of partners and help shape the future of cross-chain DeFi. We're always looking
              for innovative projects to collaborate with.
            </p>
            <Button asChild variant="outline" className="rounded-xl group">
